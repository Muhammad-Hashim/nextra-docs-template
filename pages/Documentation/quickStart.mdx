...
There are even more of these factory methods, you can find them in the [tensor.py](https://github.com/tinygrad/tinygrad/blob/master/tinygrad/tensor.py) file.
...
Additionally reading through [abstractions.py](https://github.com/tinygrad/tinygrad/blob/master/docs/abstractions.py) will help you understand how operations on these tensors make their way down to your hardware.
